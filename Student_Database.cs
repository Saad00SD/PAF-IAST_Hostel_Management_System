...
namespace Databaseproject
{
	public partial class Student_Database : Form
	{
        ...
        private void NameSearch_Click(object sender, EventArgs e)
        {
			...
			SqlCommand cmd = new SqlCommand("SELECT *FROM Student_Database WHERE Student_Name LIKE @StudentName", con);
       
			cmd.Parameters.AddWithValue("@StudentName","%" +  comboBox1.Text + "%");
        ...
        private void gunaAdvenceButton3_Click(object sender, EventArgs e)
        {
            ...
            reportViewer1.LocalReport.ReportPath = @"C:\Users\saadf\OneDrive\Desktop\New\DBMS_LAST_Project\Databaseproject\Databaseproject\Report\ReportStudentDB.rdlc";
