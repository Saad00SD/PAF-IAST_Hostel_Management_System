...
namespace Databaseproject
{
	public partial class Mess_Menu : Form
	{
        ...
        private void GetStudentRecord()
        {
            ...
            cmd = new SqlCommand("SELECT Day, Breakfast, Lunch, Brunch, Dinner FROM Messing_Menu", con);
            ...
            {
                i++;
                MessMenuDBRecordGridView.Rows.Add(i, dr[0].ToString(), dr[1].ToString(), dr[2].ToString(), dr[3].ToString(), dr[4].ToString());
        ...
        private void MessMenuDBRecordGridView_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            comboBox2.Text = MessMenuDBRecordGridView.SelectedRows[0].Cells[1].Value.ToString();
            gunaTextBox1.Text = MessMenuDBRecordGridView.SelectedRows[0].Cells[2].Value.ToString();
            gunaTextBox2.Text = MessMenuDBRecordGridView.SelectedRows[0].Cells[3].Value.ToString();
            gunaTextBox3.Text = MessMenuDBRecordGridView.SelectedRows[0].Cells[4].Value.ToString();
            gunaTextBox4.Text = MessMenuDBRecordGridView.SelectedRows[0].Cells[5].Value.ToString();
        }
        ...
        private void gunaAdvenceButton1_Click(object sender, EventArgs e)
        {
            ...
            DateTime date1 = DateTime.Parse(gunaDateTimePicker3.Text);
            DateTime date2 = DateTime.Parse(gunaDateTimePicker1.Text);
            SqlCommand cmd = new SqlCommand("SELECT Day, Breakfast, Lunch, Brunch, Dinner FROM Messing_Menu WHERE Month='" + comboBox3.Text + "' ", con);
            ...
            reportViewer1.LocalReport.ReportPath = @"C:\Users\saadf\OneDrive\Desktop\New\DBMS_LAST_Project\Databaseproject\Databaseproject\Report\MessMenuReport.rdlc";
