...
namespace Databaseproject.ReportDataset {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmployeeDataTable : global::System.Data.TypedTableBase<EmployeeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public EmployeeRow AddEmployeeRow(string Emp_Id, string Employee_Name, string Phone_No, string Position, string Remarks) {
        ...
        public partial class EmployeeRow : global::System.Data.DataRow {
            ...
            public string Remarks {
                get {
                    try {
                        return ((string)(this[this.tableEmployee.RemarksColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Remarks\' in table \'Employee\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableEmployee.RemarksColumn] = value;
                }
            }
            ...
            public bool IsRemarksNull() {
                return this.IsNull(this.tableEmployee.RemarksColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetRemarksNull() {
                this[this.tableEmployee.RemarksColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace Databaseproject.ReportDataset.EmployeeDataSetTableAdapters {
    ...
    public partial class EmployeeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Employee] WHERE (([Emp_Id] = @Original_Emp_Id) AND ((@IsNull_Employee_Name = 1 AND [Employee_Name] IS NULL) OR ([Employee_Name] = @Original_Employee_Name)) AND ((@IsNull_Phone_No = 1 AND [Phone_No] IS NULL) OR ([Phone_No] = @Original_Phone_No)) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks] = @Original_Remarks)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Employee] ([Emp_Id], [Employee_Name], [Phone_No], [Position], " +
                "[Remarks]) VALUES (@Emp_Id, @Employee_Name, @Phone_No, @Position, @Remarks);\r\nSE" +
                "LECT Emp_Id, Employee_Name, Phone_No, Position, Remarks FROM Employee WHERE (Emp" +
                "_Id = @Emp_Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Employee] SET [Emp_Id] = @Emp_Id, [Employee_Name] = @Employee_Name, [Phone_No] = @Phone_No, [Position] = @Position, [Remarks] = @Remarks WHERE (([Emp_Id] = @Original_Emp_Id) AND ((@IsNull_Employee_Name = 1 AND [Employee_Name] IS NULL) OR ([Employee_Name] = @Original_Employee_Name)) AND ((@IsNull_Phone_No = 1 AND [Phone_No] IS NULL) OR ([Phone_No] = @Original_Phone_No)) AND ((@IsNull_Position = 1 AND [Position] IS NULL) OR ([Position] = @Original_Position)) AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks] = @Original_Remarks)));
SELECT Emp_Id, Employee_Name, Phone_No, Position, Remarks FROM Employee WHERE (Emp_Id = @Emp_Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Emp_Id, Employee_Name, Phone_No, Position, Remarks FROM dbo.Employee";
        ...
        public virtual int Delete(string Original_Emp_Id, string Original_Employee_Name, string Original_Phone_No, string Original_Position, string Original_Remarks) {
        ...
        public virtual int Insert(string Emp_Id, string Employee_Name, string Phone_No, string Position, string Remarks) {
            if ((Emp_Id == null)) {
        ...
        public virtual int Update(string Emp_Id, string Employee_Name, string Phone_No, string Position, string Remarks, string Original_Emp_Id, string Original_Employee_Name, string Original_Phone_No, string Original_Position, string Original_Remarks) {
            if ((Emp_Id == null)) {
                throw new global::System.ArgumentNullException("Emp_Id");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Employee_Name, string Phone_No, string Position, string Remarks, string Original_Emp_Id, string Original_Employee_Name, string Original_Phone_No, string Original_Position, string Original_Remarks) {
            return this.Update(Original_Emp_Id, Employee_Name, Phone_No, Position, Remarks, Original_Emp_Id, Original_Employee_Name, Original_Phone_No, Original_Position, Original_Remarks);
        }
    }
