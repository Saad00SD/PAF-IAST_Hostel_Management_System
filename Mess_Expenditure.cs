	...
	public partial class Mess_Expenditure : Form
	{
       ...
       /*    }
        ...
        private void gunaAdvenceButton1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("SELECT DISTINCT COUNT(*) FROM Student_Attendance WHERE Date BETWEEN '" + date1.ToString("MM/dd/yyyy") + "' AND '" + date2.ToString("MM/dd/yyyy") + "' ", con);
            con.Open();
            ...
            */
            ...
            if (e.KeyCode == Keys.Enter)
            {
                ...
                DateTime date2 = DateTime.Parse(gunaDateTimePicker7.Text);
                    ...
                    SqlCommand cmd = new SqlCommand("SELECT SUM(Bill_Amount) AS TotalSum FROM Mess_Expenditure WHERE Date >= @StartDate AND Date <= @EndDate", con);
		...
		private void PrintBtn_Click(object sender, EventArgs e)
		{
			...
			reportViewer1.LocalReport.ReportPath = @"C:\Users\saadf\OneDrive\Desktop\New\DBMS_LAST_Project\Databaseproject\Databaseproject\Report\MessExpenditureReport.rdlc";
